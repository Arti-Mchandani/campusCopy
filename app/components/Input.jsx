...
export function Input({className = '', type, variant, ...props}) {
  const variants = {
    ...
    minisearch:
      'bg-transparent hidden md:inline-block text-left border-b transition border-transparent -mb-px border-x-0 border-t-0 appearance-none px-0 py-1 focus:ring-transparent placeholder:opacity-20 placeholder:text-inherit',
  };
